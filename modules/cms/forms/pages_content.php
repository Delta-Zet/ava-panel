...
$textField = 'body';
include(_W.'forms/widget_select.php');
$matrix['widget']['pre_text'] = '<div class="contentwidget">';
$matrix['widget']['text'] = '';

$matrix['simple_html']['type'] = 'checkbox';
$matrix['simple_html']['text'] = 'Непосредственный ввод HTML';
$matrix['simple_html']['post_text'] = '</div>';
