...
class payLS extends paymentsObject{
	...
	public function __ava__paymentForm($params){
		...
		*/
		...
		elseif(empty($this->settings['secretKey'])){
			$this->obj->setMeta('{Call:Lang:modules:billing:oplata:'.Library::serialize(array($params['text'])).'}');
			if(!$this->payParams['comment']){
				$this->payParams['comment'] = '{Call:Lang:modules:billing:avtomatiches:'.Library::serialize(array($params['payParams']['vars']['purse'])).'}';
			}
	...
	*********************************************************************************************************************************************************************/
	...
	public static function getInstallParams(){
		return array('{Call:Lang:modules:billing:kreditnyjmag}', 'LS');
	}
}
